...
#uma r stang OY
def paharStanga():
    moveServoSlowly(1, 90, 0, 0.02)
    moveServoSlowly(1, 0, 90, 0.02)
    moveServoSlowly(1, 90, 0, 0.02)
    moveServoSlowly(6, 25, 0, 0.02)
    moveServoSlowly(7, 0, 90, 0.02)
    moveServoSlowly(10, 0, 90, 0.02)
    moveServoSlowly(8, 0, 45, 0.02)
    moveServoSlowly(9, 180, 0, 0.02)
    moveServoSlowly(11, 180, 0, 0.02)
    ...
    moveServoSlowly(9, 0, 180, 0.02)
    moveServoSlowly(11, 0, 180, 0.02)
    #time.sleep(1)
...
def joci():
    ...
    moveServoSlowly(9, 180, 0, 0.01)
    moveServoSlowly(11, 180, 0, 0.01)
    ...
    moveServoSlowly(7, 0, 120, 0.02)
    if x == 2:
        moveServoSlowly(11, 0, 180, 0.008)
        print("foarfeca")
        engine.say("i chose scissor")
    elif x==1:
        moveServoSlowly(9, 0, 180, 0.008)
        moveServoSlowly(11, 0, 180, 0.008)
        print("hartie")
